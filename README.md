...
* Once forked, you should have access to [pip](https://pypi.org/project/pip/) to install everything from [main/requirements.txt](requirements.txt).
Alternatively, install pip with python using `python -m ensurepip`, although you should be sure to follow each other step with `python -m`

* For building your repository, make sure you have [nodejs](https://nodejs.org/en/download).
Alternatively, install nodejs with pip using `pip install nodejs-bin`
